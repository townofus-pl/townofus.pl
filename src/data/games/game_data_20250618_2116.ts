...
export const gameData: GameData = {
  metadata: {
    startTime: "2025-06-25 21:16:23",
    endTime: "2025-06-25 21:35:11",
    duration: "07:49",
    playerCount: 14,
    map: "Polus",
    maxTasks: 9,
  ...
  players: [
    ...
    },
    {
      ...
      modifiers: ["S_Time Lord", "Frosty", "Shy"],
      win: 1,
      disconnected: 0,
      initialRolePoints: 0,
      correctKills: 0,
    ...
    },
    {
      ...
      roleHistory: ["Executioner", "Amnesiac", "Snitch", "Traitor"],
      modifiers: ["Satellite"],
      win: 0,
      disconnected: 0,
      initialRolePoints: 0,
    ...
    {
      playerName: "GIMPER 2",
      roleHistory: ["SoulCollector", "Phantom"],
      modifiers: ["Mini"],
      win: 0,
      disconnected: 0,
      initialRolePoints: 0,
