      ...
      <div className="inset-0 z-10 flex items-center justify-center rounded-xl mt-5 mb-5">
        <div className="text-white text-center px-4 rounded-xl">
          <div className="relative text-center text-white">
            <p className="text-red-500 text-8xl font-brook font-bold drop-shadow-[0_0_10px_rgba(255,0,0,0.7)]">Lobby na ponad 15 osób</p>
          </div>
          <br />
          ...
          <a
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-4 py-3 bg-[rgba(114,137,218)] hover:bg-[rgba(114,137,218,0.85)] text-white text-lg font-sans font-semibold rounded-lg transition duration-300 inline-flex items-center"
            >
