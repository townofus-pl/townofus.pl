  ...
  return (
    <main className="min-h-screen rounded-xl bg-zinc-900/50 text-white px-4 py-8 flex flex-col items-center">
      <div className="max-w-xl w-full">
        <h1 className="text-2xl md:text-3xl font-bold mb-4">PORADNIK JAK MIEĆ SKINY DRAMA AFERA</h1>
        <ol className="list-decimal list-inside space-y-1 mb-4 text-lg">
          ...
          <li>Ciesz się super skinami!!!</li>
        </ol>
        <p className="text-xs text-[#b0aeb8] mb-6">
          PS. robimy kopie bo ludzie ktorzy nie beda mieli tych plikow nie będą widzieć waszych skinów na skrzynkach i innych serwerach
        </p>
